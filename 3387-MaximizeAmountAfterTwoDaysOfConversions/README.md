...
**Difficulty:** Medium  
[View on LeetCode](https://leetcode.com/problems/maximize-amount-after-two-days-of-conversions/)
...
- Convert **EUR** to **USD** to get 2.0 **USD**. - Convert **USD** to **JPY** to get 6.0 **JPY**.
