...
**Difficulty:** Medium  
[View on LeetCode](https://leetcode.com/problems/design-event-manager/)
...
EventManager eventManager = new EventManager([[5,7], [2,7], [9,4]]); // Initializes the manager with three events **eventManager.pollHighest(); // both events 5 and 2 have priority 7, so return the smaller id 2  
...
EventManager eventManager = new EventManager([[4,1], [7,2]]); // Initializes the manager with two events **eventManager.pollHighest(); // return 7  
